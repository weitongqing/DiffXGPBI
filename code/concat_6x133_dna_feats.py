...
if __name__ == '__main__':
    walkfile = walkFile('/bios-store1/home/TongqingWei/phage/phage_external/PHIAF/dna_feature')
    ...
    for ls in walkfile:
        if ls[-3:] == 'csv':
            KP = pd.read_csv("/bios-store1/home/TongqingWei/phage/phage_external/PHIAF/dna_feature/" + ls, header = 0)
    ...
    KP_df.to_csv("/bios-store1/home/TongqingWei/phage/phage_external/PHIAF/dna_feature/dna_features.csv")